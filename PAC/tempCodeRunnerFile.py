...
# Run the program
    def authenticate(self):
        ...
        if self.password==None and self.username==None:
            messagebox.showerror("Credentials Error','Plaese Enter Username or Password")
        elif rows:
    ...
    def dashboard(self):
        ...
        res=cur.fetchone()[0]
        self.admin=Button(self.main,text=f'Admin : {res}',font=('arial',12),padx=10)
        self.admin.place(x=20,y=10)
        self.logout=Button(self.main,text='Logout',font=('arial',12),padx=10,command=self.logout)
        self.logout.place(x=1800,y=10)
        #----------------------------------------------------------------
    ...
    def PACdashboard(self):
        ...
        self.total_revenue.place(x=910,y=50 ,width=200,height=100)
    ...
    def showPatient(self):
        ...
        self.searchbtn = Button(self.rightFrame, text='Search', bd=1, relief='solid', font=('Arial', 12), command=self.search_patient)
